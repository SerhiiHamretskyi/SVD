...
Welcome to `svd_project` contributor's guide.
...
If you experience bugs or general issues with `svd_project`, please have a look
...
You can help improve `svd_project` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`svd_project` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `svd_project`'s files. While this mechanism can
...
```
conda create -n svd_project python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/svd_project.git
   cd svd_project
   ```
...
5. Install [pre-commit]:
   ...
   `svd_project` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/svd_project
[issue tracker]: https://github.com/<USERNAME>/svd_project/issues
